...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_lebal = Label(text="Score : 0", fg="white", bg=THEME_COLOR)
        self.score_lebal.grid(row=0, column=1)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
             self.score_lebal.config(text=f"score: {self.quiz.score}")
    ...
    def restart_game(self):
        # Reset the QuizBrain instance and update UI
        new_quiz_brain = QuizBrain(new_question_list) 
        self.quiz = new_quiz_brain
